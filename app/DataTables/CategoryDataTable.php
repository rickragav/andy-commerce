...
class CategoryDataTable extends DataTable
{
    ...
    {
        return [Column::make('id')->width(50), Column::make('icon')->width(300), Column::make('name'), Column::make('status')->width(200), Column::computed('action')->exportable(false)->printable(false)->width(200)->addClass('text-center')];
    }
