                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-infor">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>Email: <a href="my-account-edit.html#">info@fashionshop.com</a></p>
                                </li>
                                <li>
                                    <p>Phone: <a href="my-account-edit.html#">(212) 555-1234</a></p>
                                </li>
                            </ul>
                            <a href="contact-1.html" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a>
                            <ul class="tf-social-icon d-flex gap-10">
                                <li><a href="my-account-edit.html#" class="box-icon w_34 round social-facebook border-line-black"><i class="icon fs-14 icon-fb"></i></a></li>
                                <li><a href="my-account-edit.html#" class="box-icon w_34 round social-twiter border-line-black"><i class="icon fs-12 icon-Icon-x"></i></a></li>
                                <li><a href="my-account-edit.html#" class="box-icon w_34 round social-instagram border-line-black"><i class="icon fs-14 icon-instagram"></i></a></li>
                                <li><a href="my-account-edit.html#" class="box-icon w_34 round social-tiktok border-line-black"><i class="icon fs-14 icon-tiktok"></i></a></li>
                                <li><a href="my-account-edit.html#" class="box-icon w_34 round social-pinterest border-line-black"><i class="icon fs-14 icon-pinterest-1"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-newsletter footer-col-block">
                            ...
                            <div class="tf-collapse-content">
                                ...
                                <form class="form-newsletter" id="subscribe-form" action="my-account-edit.html#" method="post" accept-charset="utf-8" data-mailchimp="true">
