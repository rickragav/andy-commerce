<div class="col-lg-3">
    <ul class="my-account-nav">
        <li><a href="{{route('user.dashboard')}}" class="my-account-nav-item {{ Request::is('user/dashboard') ? 'active' : '' }}" >Dashboard</a></li>
        ...
        <li><a href="{{route('user.profile')}}" class="my-account-nav-item {{ Request::is('user/profile') ? 'active' : '' }}">Account Details</a></li>
