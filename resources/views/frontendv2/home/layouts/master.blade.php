...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        ...
        @include('frontendv2.preload')

        <!-- /preload -->

        <!-- Top bar -->

        @include('frontendv2.home.layouts.topbar')

        <!-- /Top bar -->

        <!-- header -->

        @include('frontendv2.home.layouts.header')
        ...
        <!-- footer -->
        @include('frontendv2.home.layouts.footer')
        <!-- /footer -->
                    ...
                    <div class="tf-mini-cart-wrap">
                        ...
                        <div class="tf-mini-cart-bottom">
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                ...
                                <div class="tf-cart-tax">Taxes and <a href="home-02.html#">shipping</a> calculated at
                                    checkout</div>
                                ...
                                <div class="tf-cart-checkbox">
                                    ...
                                    <label for="CartDrawer-Form_agree">
                                        I agree with the
                                        <a href="home-02.html#" title="Terms of Service">terms and conditions</a>
                                    </label>
                                </div>
