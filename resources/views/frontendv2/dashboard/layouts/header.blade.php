    ...
    <div class="px_15 lg-px_40">
        <div class="row wrapper-header align-items-center">
            <div class="col-md-4 col-3 tf-lg-hidden">
                <a href="my-account-edit.html#mobileMenu" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
            ...
            <div class="col-xl-6 tf-md-hidden">
                <nav class="box-navigation text-center">
                    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                        <li class="menu-item">
                            <a href="my-account-edit.html#" class="item-link">Home<i class="icon icon-arrow-down"></i></a>
                            <div class="sub-menu mega-menu">
                                <div class="container">
                                    ...
                                    <div class="text-center view-all-demo">
                                        <a href="my-account-edit.html#modalDemo" data-bs-toggle="modal" class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View all demos (31+)</span><i class="icon icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="menu-item">
                            <a href="my-account-edit.html#" class="item-link">Shop<i class="icon icon-arrow-down"></i></a>
                            <div class="sub-menu mega-menu">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-2">
                        ...
                        <li class="menu-item">
                            <a href="my-account-edit.html#" class="item-link">Products<i class="icon icon-arrow-down"></i></a>
                            <div class="sub-menu mega-menu">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-2">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide" lazy="true">
                                                            <div class="card-product">
                                                                <div class="card-product-wrapper">
                                                                    <a href="my-account-edit.html#" class="product-img">
                                                                    ...
                                                                    <div class="list-product-btn">
                                                                        <a href="my-account-edit.html#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                        ...
                                                                        <a href="my-account-edit.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="box-icon bg_white compare btn-icon-action">
                                                                            <span class="icon icon-compare"></span>
                                                                            <span class="tooltip">Add to Compare</span>
                                                                            <span class="icon icon-check"></span>
                                                                        </a>
                                                                        <a href="my-account-edit.html#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                                                                ...
                                                                <div class="card-product-info">
                                                                    <a href="my-account-edit.html#" class="title link">Ribbed Tank Top</a>
                                                            ...
                                                            <div class="card-product">
                                                                <div class="card-product-wrapper">
                                                                    ...
                                                                    <div class="list-product-btn absolute-2">
                                                                        <a href="my-account-edit.html#shoppingCart" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                            <span class="icon icon-bag"></span>
                                                                ...
                                                                <div class="card-product-info">
                                                                    <a href="my-account-edit.html#" class="title link">Oversized Printed T-shirt</a>
                                                        ...
                                                        <div class="swiper-slide" lazy="true">
                                                            <div class="card-product">
                                                                ...
                                                                <div class="card-product-info">
                                                                    <a href="my-account-edit.html#" class="title">Oversized Printed T-shirt</a>
                                                                    <span class="price">$16.95</span>
                                                                    <ul class="list-color-product">
                                                                        <li class="list-color-item color-swatch active">
                                                                            <span class="tooltip">White</span>
                                                        ...
                                                        <div class="swiper-slide" lazy="true">
                                                            <div class="card-product">
                                                                ...
                                                                <div class="card-product-info">
                                                                    <a href="my-account-edit.html#" class="title link">V-neck linen T-shirt</a>
                        ...
                        <li class="menu-item position-relative">
                            <a href="my-account-edit.html#" class="item-link">Pages<i class="icon icon-arrow-down"></i></a>
                        ...
                        <li class="menu-item position-relative">
                            <a href="my-account-edit.html#" class="item-link">Blog<i class="icon icon-arrow-down"></i></a>
                            <div class="sub-menu submenu-default">
                                <ul class="menu-list">
            ...
            <div class="col-xl-3 col-md-4 col-3">
                <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                    <li class="nav-search"><a href="my-account-edit.html#canvasSearch" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="nav-icon-item"><i class="icon icon-search"></i></a></li>
                    <li class="nav-account"><a href="my-account-edit.html#login" data-bs-toggle="modal" class="nav-icon-item"><i class="icon icon-account"></i></a></li>
                    ...
                    <li class="nav-cart"><a href="my-account-edit.html#shoppingCart" data-bs-toggle="modal" class="nav-icon-item"><i class="icon icon-bag"></i><span class="count-box">0</span></a></li>
                </ul>
            </div>
        </div>
    </div>
